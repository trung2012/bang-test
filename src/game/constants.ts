...
export const characters: ICharacter[] = [
  {
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888948/bang/original/bartcassidy_ouhp6h.png',
  },
  {
    name: 'black jack',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888949/bang/original/blackjack_cgpncq.png',
  },
  {
    name: 'calamity janet',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888949/bang/original/calamityjanet_tfl8jr.png',
  },
  {
    name: 'el gringo',
    hp: 3,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888949/bang/original/elgringo_qql1r7.png',
  },
  {
    name: 'jesse jones',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888949/bang/original/jessejones_wb46wp.png',
  },
  {
    name: 'jourdonnais',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888950/bang/original/jourdonnais_znr8vy.png',
  },
  {
    name: 'kit carlson',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888950/bang/original/kitcarlson_a9jhr2.png',
  },
  {
    name: 'lucky duke',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888950/bang/original/luckyduke_rq6oly.png',
  },
  {
    name: 'paul regret',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888950/bang/original/paulregret_qxlr6x.png',
  },
  {
    name: 'pedro ramirez',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888950/bang/original/pedroramirez_ygknav.png',
  },
  {
    name: 'rose doolan',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888950/bang/original/rosedoolan_m26vr9.png',
  },
  {
    name: 'sid ketchum',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888948/bang/original/sidketchum_o4uwhe.png',
  },
  {
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888948/bang/original/slab_fwl52n.png',
  },
  {
    name: 'suzy lafayette',
    hp: 4,
    description: 'As soon as she has no cards in her hand, she draws a card from the draw pile.',
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888948/bang/original/suzylafayette_nxju4w.png',
  },
  {
    name: 'vulture sam',
    hp: 4,
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888948/bang/original/vulturesam_yqdj2y.png',
  },

  {
    ...
    imageUrl: 'https://res.cloudinary.com/trungpham/image/upload/v1602888948/bang/original/willythekid_avzxon.png',
  },
];

export const gameRolesByNumPlayers = {
...
export const roleLookup: { [key: number]: string } = {
  0: 'sheriff',
  1: 'renegade',
  2: 'outlaw',
  3: 'deputy',
